...
const ccxt_1 = require("../../src/exchanges/ccxt");
...
describe('CCXT Exchange Wrapper', () => {
    ...
    before(() => __awaiter(this, void 0, void 0, function* () {
        setupMocks();
        const auth = { key: null, secret: null };
        wrapper = ccxt_1.default.createExchange(exchangeId, auth, Logger_1.NullLogger);
    }));
    it('is able to fetch historical trade data from an exchange', () => __awaiter(this, void 0, void 0, function* () {
        const data = yield wrapper.fetchHistTrades(productId);
        assert(data.length && data.length > 0);
    }));
    it('is able to fetch historical OHLCV candlestick data from an exchange', () => __awaiter(this, void 0, void 0, function* () {
        const data = yield wrapper.fetchOHLCV(productId);
        assert.notEqual(data, null);
        assert(data.length && data.length > 0);
    }));
    it('is able to fetch a ticker', () => __awaiter(this, void 0, void 0, function* () {
        const data = yield wrapper.loadTicker(productId);
        assert(data.bid > data.ask);
    }));
    it('is able to load an orderbook image', () => __awaiter(this, void 0, void 0, function* () {
        const data = yield wrapper.loadOrderbook(productId);
        assert(data.numAsks > 0 && data.numBids > 0);
    }));
});
//# sourceMappingURL=CCXTExchangeTest.js.map