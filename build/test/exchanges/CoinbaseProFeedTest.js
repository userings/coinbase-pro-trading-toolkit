...
const CoinbaseProFeed_1 = require("../../src/exchanges/coinbasePro/CoinbaseProFeed");
...
describe('Coinbase Pro Message feed', () => {
    const messages = [
        {
            type: 'l2update',
            product_id: 'BTC-USD',
    ...
    before(() => {
        ...
        coinbaseProFeed = new CoinbaseProFeed_1.CoinbaseProFeed({
            logger: null,
            auth: null,
            apiUrl: '',
            wsUrl: '',
        ...
        coinbaseProFeed.pipe(book);
    });
    after(() => {
        coinbaseProFeed.disconnect();
    });
    it('produces a matching live Coinbase Pro book', (done) => {
...
describe('Coinbase Pro feed with channels', () => {
    let book;
    let coinbaseProFeed;
    const messages = [
        {
    ...
    before(() => {
        ...
        coinbaseProFeed = new CoinbaseProFeed_1.CoinbaseProFeed({
            ...
            apiUrl: '',
            auth: null,
            wsUrl: CoinbaseProFeed_1.COINBASE_PRO_WS_FEED,
            channels: null
        });
        book = new LiveOrderbook_1.LiveOrderbook({
            logger: Logger_1.NullLogger,
...
//# sourceMappingURL=CoinbaseProFeedTest.js.map