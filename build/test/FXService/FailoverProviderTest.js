...
const coinbaseProFactories_1 = require("../../src/factories/coinbaseProFactories");
...
describe('FailoverProvider', () => {
    ...
    before(() => {
        provider = new FailoverProvider_1.FailoverProvider({
            ...
            providers: [
                new CryptoProvider_1.CryptoProvider({ logger: Logger_1.NullLogger, exchange: coinbaseProFactories_1.DefaultAPI(Logger_1.NullLogger) }),
    ...
    it('rejects for unsupported currencies', () => {
        ...
        return provider.fetchCurrentRate({ from: 'BTC', to: 'XYZ' }).then((_result) => {
