...
export declare function AggregatedLevelFactory(totalSize: Biglike, price: Biglike, side: Side): AggregatedLevelWithOrders;
...
export declare class BookBuilder extends EventEmitter implements Orderbook {
    sequence: number;
    protected readonly bids: RBTree<AggregatedLevelWithOrders>;
    protected readonly asks: RBTree<AggregatedLevelWithOrders>;
    ...
    addLevel(side: Side, level: AggregatedLevelWithOrders): void;
    /**
