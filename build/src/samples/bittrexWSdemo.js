...
const product = 'BTC-ETH';
const config = {
    logger: logger,
    auth: null,
    wsUrl: null
};
const feed = new BittrexFeed_1.BittrexFeed(config);
...
function doSomethingWithFeed() {
    const book = new LiveOrderbook_1.LiveOrderbook({ logger: logger, product: product, strictMode: false });
...
//# sourceMappingURL=bittrexWSdemo.js.map