...
const coinbasePro = new CoinbaseProExchangeAPI_1.CoinbaseProExchangeAPI(coinbaseProConfig);
const bittrex = bittrexFactories_1.DefaultAPI(logger);
const publicExchanges = [bitfinex, coinbasePro, bittrex];
...
const runAuth = !!bitfinexConfig.auth.key && !!coinbaseProConfig.auth.key;
if (runAuth) {
    const authExchanges = [coinbasePro, bitfinex];
