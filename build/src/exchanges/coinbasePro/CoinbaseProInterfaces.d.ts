...
export interface CoinbaseProConfig {
    apiUrl?: string;
    auth?: CoinbaseProAuthConfig;
    logger: Logger;
}
export interface CoinbaseProAuthConfig extends ExchangeAuthConfig {
    passphrase: string;
}
...
export interface CoinbaseProAccountResponse {
    id: string;
    currency: string;
    balance: string;
    available: string;
...
export interface CoinbaseProHTTPError {
    message: string;
    response: any;
}
