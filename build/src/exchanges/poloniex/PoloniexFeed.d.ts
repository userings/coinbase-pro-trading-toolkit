...
export declare class PoloniexFeed extends ExchangeFeed {
    ...
    private handle_user_message;
    private handle_trollbox_message;
    private handle_total_volume_message;
    private handle_ticker_message;
    private handle_unknown_system_message;
    private handle_orderbook_message;
