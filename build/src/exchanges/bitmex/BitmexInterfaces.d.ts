 ...
 ***************************************************************************************************************************/
export declare type ActionType = 'partial' | 'update' | 'insert' | 'delete';
export declare type BitmexSide = 'Buy' | 'Sell';
...
export declare type TickDirection = 'MinusTick' | 'PlusTick' | 'ZeroMinusTick' | 'ZeroPlusTick';
