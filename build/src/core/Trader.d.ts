...
import { PlaceOrderMessage, StreamMessage, StreamMessageLike } from './Messages';
...
export declare function isCancelMyOrdersRequestMessage(msg: any): msg is CancelMyOrdersRequestMessage;
export interface CancelAllOrdersRequestMessage extends StreamMessageLike {
    type: 'cancelAllOrders';
}
export declare function isCancelAllOrdersRequestMessage(msg: any): msg is CancelAllOrdersRequestMessage;
export declare type TraderStreamMessage = StreamMessage | CancelMyOrdersRequestMessage | CancelAllOrdersRequestMessage;
export declare function isTraderStreamMessage(msg: any): msg is TraderStreamMessage;
/**
...
export declare class Trader extends Writable {
    ...
    private readonly myBook;
    private readonly api;
    private _fitOrders;
    private readonly sizePrecision;
    private readonly pricePrecision;
    private readonly unfilledMarketOrders;
    ...
    executeMessage(msg: any): void;
    _write(msg: any, _encoding: string, callback: (err?: Error) => any): void;
    private handleOrderRequest;
    private handleCancelOrder;
    private handleTradeExecutedMessage;
    private handleTradeFinalized;
    /**
     ...
     */
    private handleOrderPlacedConfirmation;
    /**
